// Package server manages the gRPC and HTTP server lifecycle for the Gateway.
// It handles graceful startup and shutdown, health endpoints, and middleware
// configuration.
package server
...
import (
	...
	grpcHandler "github.com/rahlplx/polyglot-microservices-platform/services/gateway/adapters/inbound/grpc"
	restController "github.com/rahlplx/polyglot-microservices-platform/services/gateway/adapters/inbound/rest"
...
// Server manages the combined gRPC and HTTP server lifecycle.
type Server struct {
	config      ServerConfig
...
// buildGRPCServer creates and configures the gRPC server.
